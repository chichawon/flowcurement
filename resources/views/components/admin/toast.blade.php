...
@if ($message)
    ...
    >
        <div class="flex items-start gap-3 p-4">
            <div class="grid size-9 shrink-0 place-items-center rounded-full {{ $styles['iconClass'] }}">
            ...
            <div class="min-w-0 flex-1 pt-0.5">
                <p class="text-sm font-semibold text-slate-950">{{ $message }}</p>
            </div>
        ...
        <div class="h-1 {{ $styles['barClass'] }}"></div>
    </div>
@endif
