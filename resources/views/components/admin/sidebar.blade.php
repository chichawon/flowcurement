@php
    ...
    $navigation = [
        ...
        [
            ...
            'icon' => 'M21 7.5 12 2.25 3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25m0-9L3 7.5m9 5.25v9m-9-14.25v9l9 5.25',
            'children' => [
                ['label' => 'Stock List', 'url' => route('inventory.stock.index'), 'active' => request()->routeIs('inventory.stock.*') || request()->routeIs('inventory.index')],
                ['label' => 'Stock Movements', 'url' => route('inventory.movements.index'), 'active' => request()->routeIs('inventory.movements.*')],
                ['label' => 'Stock Adjustment', 'permission' => 'inventory.update', 'url' => route('inventory.adjustments.create'), 'active' => request()->routeIs('inventory.adjustments.*')],
            ],
        ],
        ...
        [
            ...
            'children' => [
                ['label' => 'Top 10 Business Partners', 'url' => route('reports.top-business-partners'), 'active' => request()->routeIs('reports.top-business-partners')],
                ['label' => 'Company Top Ordered Items', 'url' => route('reports.company-top-ordered-items'), 'active' => request()->routeIs('reports.company-top-ordered-items')],
            ],
        ],
