...
class QuotationPolicy
{
    ...
    public function update(User $actor, Quotation $quotation): bool { return $actor->can(QuotationPermissions::UPDATE); }
    public function delete(User $actor, Quotation $quotation): bool { return $actor->can(QuotationPermissions::DELETE); }
